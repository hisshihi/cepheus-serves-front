    ...
    <div class="evaluations">
      ...
      <div class="evaluation-lines">
        <div class="line">
          ...
          <div class="progress">
            <div class="progress-value" :style="{ width: percentageCount5 + '%' }"></div>
          </div>
        ...
        <div class="line">
          ...
          <div class="progress">
            <div class="progress-value" :style="{ width: percentageCount4 + '%' }"></div>
          </div>
        ...
        <div class="line">
          ...
          <div class="progress">
            <div class="progress-value" :style="{ width: percentageCount3 + '%' }"></div>
          </div>
        ...
        <div class="line">
          ...
          <div class="progress">
            <div class="progress-value" :style="{ width: percentageCount2 + '%' }"></div>
          </div>
        ...
        <div class="line">
          ...
          <div class="progress">
            <div class="progress-value" :style="{ width: percentageCount1 + '%' }"></div>
          </div>
    ...
    <div class="evaluations-users">
      <div class="users" v-for="review in reviews" :key="review.id">
        <div class="user">
          ...
          <div class="rating">
            <star-rating-component :rating="review.rating"></star-rating-component>
          </div>
